# Customer App (Flutter, Android) — Screen Inventory
...
| C04 | OTP Verification (required) | `C04_OTPVerification.md` | Verify WhatsApp number via OTP (AWS SNS) — Confirmed Q2 |
| C05 | Category (Home) | `C05_CategoryHome.md` | Location-filtered category cards + offers banner |
| C06 | Product List | `C06_ProductList.md` | Products for a category; flip cards; qty add; scroll strip |
| C07 | Cart / Checkout | `C07_CartCheckout.md` | Review items, recommended products (cross-sell), delivery time, payment, place order |
| C08 | Order Confirmation | `C08_OrderConfirmation.md` | Success + invoice download |
...
| C13 | Settings | `C13_Settings.md` | App preferences, logout, legal links |
